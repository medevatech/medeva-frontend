      ...
      <Row>
        <Colxx xxs="12">
          <Row>
            <Colxx sm="10">
              <h2><b>Kelas B</b></h2>
              <p>Prospective Payment System</p>
            </Colxx>
            ...
            <CardBody>
              ...
              >
                ...
                {/* {isLoading && rowSelected === false ? (
                  ...
                  <tr>
                    <th>1</th>
                    <td><h6 style={{ fontWeight: 'bold' }}>dr. Lorem Ipsum 1</h6></td>
                  ...
                  <tr>
                    <th>4</th>
                    <td><h6 style={{ fontWeight: 'bold' }}>dr. Lorem Ipsum 4</h6></td>
            ...
            <CardBody>
              ...
              >
                ...
                {/* {isLoading && rowSelected === false ? (
                  ...
                  <tr>
                    <th>1</th>
                    <td><h6 style={{ fontWeight: 'bold' }}>Penyakit A</h6></td>
                    <td className="center-xy">52</td>
                    <td>Rp24.242.424</td>
                    <td className="center-xy">23%</td>
                  </tr>
                  <tr>
                    <th>2</th>
                    <td><h6 style={{ fontWeight: 'bold' }}>Penyakit X</h6></td>
                    <td className="center-xy">39</td>
                    <td>Rp24.242.424</td>
                    <td className="center-xy">23%</td>
                  </tr>
                  <tr>
                    <th>3</th>
                    <td><h6 style={{ fontWeight: 'bold' }}>Penyakit F</h6></td>
                    <td className="center-xy">80</td>
                    <td>Rp222.222.222</td>
                    <td className="center-xy">11%</td>
                  </tr>
                  <tr>
                    <th>4</th>
                    <td><h6 style={{ fontWeight: 'bold' }}>Penyakit O</h6></td>
                    <td className="center-xy">28</td>
                    <td>Rp888.888.888</td>
                    <td className="center-xy">88%</td>
                  </tr>
                </tbody>
